// SPDX-License-Identifier: GPL-2.0-or-laterIClearinghouse
...
interface IEndpoint is IVersion {
    ...
    struct MintLp {
        bytes32 sender;
        uint32 productId;
        uint128 amountBase; // amount tokens
        uint128 quoteAmountLow; // amount USDC min
        uint128 quoteAmountHigh; // amount USDC max
        uint64 nonce;
    }
