...
abstract contract BaseEngine is IProductEngine, EndpointGated {
    ...
    function setEndpoint(address endPointAddr) public override onlyOwner {
        delete canApplyDeltas[getEndpoint()];
        super.setEndpoint(endPointAddr);
        canApplyDeltas[endPointAddr] = true;
    }
